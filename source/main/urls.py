...
from webapp.views import index_view, product_view, product_edit_view, product_add_view, product_delete_view
...
urlpatterns = [
    ...
    path('product/<int:pk>/edit/', product_edit_view, name='edit_product'),
